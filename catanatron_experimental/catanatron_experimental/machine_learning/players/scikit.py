...
from catanatron_experimental.simple_model import FEATURES

# from catanatron_experimental.simple_forest import FEATURES
...
def load_model():
    global clf
    with open("data/models/simple-scikit-linear.model", "rb") as file:
        clf = pickle.load(file)
    # with open("data/models/simple-rf.model", "rb") as file:
    #     clf = pickle.load(file)
