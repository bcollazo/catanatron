...
from catanatron.gym.envs.capstone_features import _player_production, _get_dev_cards_bought, NUM_STARTING_ROADS
...
class CapstoneReward:
    ...
    """
        Other considerations
            - port settlements
            - penalizing opponent victory points
    """
    ...
    def __init__(self, reward_type = "simple"):
        ...
        self.reward_type = REWARD_FUNCS.get(reward_type, self.simple_reward)
    ...
    def reward(self, game: Game, self_color):
        ...
        return self.reward_type(game, self_color)
